...
cfg = {
    ...
    'VGG16_quant': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 16, 8, 512, 'M', 512, 512, 512, 'M'],
    ...
    def _make_layers(self, cfg):
        ...
        for x in cfg:
            if x == 'M':
                ...
                if (in_channels == 16 & x == 8):
                    # This is for the 27th layer wherein in_channels and out_channels are both 8
                    layers +=[QuantConv2d(in_channels, x, kernel_size=3, padding=1), nn.ReLU(inplace=True)]
                else:
...
def VGG16_quant_project_multi(**kwargs):
